...
Vacation Optimizer is a travel planning web app for comparing flexible flight windows, hotel options, and full trip combinations in one place.
...
- Live search behavior can be controlled with environment switches such as `SERPAPI_ENABLED` and `MAX_LIVE_COMBINATIONS`.
